...
Page tree, bundle conventions, naming, on-disk layout, and update-mode TOC rules. Read this when planning the table of contents or deciding what to document on init.

For writing prose and diagrams, see [page-writing.md](page-writing.md). For `.wiki-meta.json` (`commitHash` baseline), see [wiki-meta.md](wiki-meta.md).
