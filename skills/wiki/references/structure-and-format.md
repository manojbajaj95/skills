...
| `.wikiignore` (repo-root read exclusions) | [wikiignore.md](wikiignore.md) |

**Init / update:** start with [toc-and-layout.md](toc-and-layout.md) to plan pages, then [page-writing.md](page-writing.md) while drafting, then [wiki-meta.md](wiki-meta.md) on assembly.
